          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <form action="page_musique.jsp" method="post">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="fichier" placeholder="Fichier">
                </div>
                <div>
                ...
                <div class="box-footer clearfix">
                  <button type="submit" class="pull-right btn btn-default" id="insert" name="insert">Inserer<i class="fa fa-arrow-circle-right"></i></button>
                </div>
              </form>
            </div>
          </div>
