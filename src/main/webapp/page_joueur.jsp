...
<head>
  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
        ...
        <%
            ...
            Jeu[] listJeu = jeu.findJeuWhereUser(request.getParameter("id"));
        %>
</head>
            ...
            <div class="box-body">
                <div class="col-md-12 col-sm-12 col-xs-6">
                    <table class="table table-sm table-dark">
                        <thead>
                            <tr>
                                <th>Joueurs(Pseudos)</th>
                                <th>Chanson</th>
                                <th>Points</th>
                            </tr>
                        </thead>
                    <% for(int i = 0; i < listJeu.length; i++) { %>                        
                    <tbody>
                        <tr class="table-primary">
                            <td class="table-info"><% out.print(request.getParameter("pseudo")); %></td>
                            <td class="table-info"><% out.print(listJeu[i].getIdChanson()); %></td>
                            <td class="table-info"><% out.print(listJeu[i].getPoints()); %></td>
                        </tr>
                    </tbody>
                    <% } %>
                    </table>
