                ...
                <div class="col-md-12 col-sm-12 col-xs-6">
                    ...
                    <script type="text/javascript">
                        ...
                        function drawChart() {
                            var data = google.visualization.arrayToDataTable([
                                ...
                                <%  int counts = 0;
                                    for(int i = 0; i < musicTable.length; i++) {   
                                        ...
                                        counts = jeuTable.length;
                                    }
                                    for(int j = 0; j < jeuTable.length; j++){ %>
                                        ["<% out.print(jeuTable[j].getIdChanson());%>", <% out.print(""+counts);%>, ""],
                                <%  } %>
                            ]);
                            ...
                            var options = {
                                title: "Statistique sur les chansons les plus utilises:",
                                width: 900,
                                height: 400,
                                bar: {groupWidth: "95%"},
